...
export const AboutUsContent0 = (
  <>
      <strong>Aux Cash For Cars Sydney</strong> has been involved in the metal recycling 
...
export const AboutUsContent2 = (
  <>
    ...
    Cash For Cars Sydney</strong>, you can drop it off and have it picked up the same day.
  </>
);
export const AboutUsContent3 = (
  <>
      You've come to the right place if you're looking to <strong>sell your used 
      car</strong> for some cash in Sydney, since Aux Cash for Cars Sydney pays 
      up to $9999.
  </>
);
...
export const CashForCarsSydney = (
  <>
    We collect and move an extensive variety of vehicles, including old as well as <strong>scrap cars</strong>, buses, lorries, tracks, 4x4s, and... All vehicle types are eligible for our cash for cars services. We provide no-charge transportation in Sydney West, East, Northern Beaches, Wollongong, Inner West, Great Western Sydney, North Shore, Macarthur, and the Hills. Our services are quick, inexpensive, and easily available 24 hours a day, seven days a week. Allow yourself to be unconcerned about (<strong>Aux Cash for Cars Sydney</strong> ) and get an acceptable cost for the vehicle you own.
  </>
)
...
export const ResyclerContnet2 = (
  <>
    We provide recycling car collection and transportation. Our <strong>cash for cars</strong>  offerings are available for all vehicle kinds. We offer supportive pickups throughout Sydney, including Sydney West, East, Northern Beaches, Wollongong, Inner West, Great Western Sydney, North Shore, Macarthur, and the Hills. Our services are quick, reasonably priced, and available around the clock. Allow yourself to be unconcerned about (<strong>Aux Cash for Cars Sydney</strong>) and make a good sum of money for your car.
  </>
)
...
export const FooterSection1 = (
  <>
    <strong>Aux Cash for Cars</strong> acquires all types of vehicles for cash and pays the highest price in comparison to other car wreckers and dealers.
  </>
);