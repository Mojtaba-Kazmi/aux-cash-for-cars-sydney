...
export const subLocation = [
  ...
  // location 1
  {
    ...
    description: (
      <>
        <p>
          Are you looking to sell your car in Seaforth, Sydney, and want to get
          the best cash offer? Look no further than{" "}
          <Link href={"/"}>Aux Cash for Cars Sydney</Link> – the premier{" "}
          <Link href={"/"}>cash for cars service</Link> in the area. With a
          reputation for offering top dollar and providing a hassle-free selling
          experience, <Link href={"/"}>Aux Cash for Cars Sydney</Link> stands
          out as the go-to choice for Seaforth residents looking to sell their
          cars quickly and lucratively.
        </p>
        <h2>Why Aux Cash for Cars Sydney?</h2>
        <ol>
          <h3>
          ...
          <p>
            ...
            offering competitive and fair cash offers for all types of cars,
            regardless of make, model, or condition. Say goodbye to the stress
            of negotiating and enjoy the peace of mind that comes with knowing
            you are getting the best value for your vehicle.
          </p>
          <h3>
          ...
          <p>
            ...
            Their streamlined and efficient selling process ensures that you can
            sell your car swiftly without unnecessary delays. From initial
            contact to the final transaction, they prioritize your time and
            convenience.
          </p>
          <h3>
          ...
          <p>
            Whether you have a used car, damaged vehicle, or an old clunker
            taking up space, <Link href={"/"}>Aux Cash for Cars Sydney</Link>{" "}
            accepts all makes and models. No need to worry about the condition
            or age of your car – they are interested in buying it from you.
          </p>
          <h3>
          ...
          <p>
            <Link href={"/"}>Aux Cash for Cars Sydney</Link> takes pride in
            providing a professional and reliable service to its customers.
            Their team of experts is dedicated to making the selling process as
            smooth as possible, answering any questions you may have and guiding
            you through each step with transparency.
          </p>
          <h3>
            <li>Free Car Removal Service: </li>
          </h3>
          <p>
            As part of their commitment to convenience,{" "}
            <Link href={"/"}>Aux Cash for Cars Sydney</Link>
            offers free car removal services. Once a deal is struck, their team
            will come to your location to pick up the car, saving you the hassle
            of arranging transportation.
          </p>
          <p>
            <b>Conclusion:</b> When it comes to getting cash for cars in
            Seaforth, Sydney, <Link href={"/"}>Aux Cash for Cars Sydney</Link>{" "}
            stands out as the best choice. With competitive cash offers, a quick
            and efficient process, and a commitment to customer satisfaction,
            they make selling your car a seamless experience. Trust{" "}
            <Link href={"/"}>Aux Cash for Cars Sydney</Link> to provide you with
            top dollar for your vehicle and make the selling process a breeze.
          </p>
        </ol>
      </>
    ),
    tags: (
      <>
        <h2>Cash for Cars Seaforth</h2>, <h2>Sell My Car Seaforth</h2>,{" "}
        <h2>Car Removal Seaforth</h2>, <h2>Instant Cash for Cars Seaforth</h2>,{" "}
        <h2>Junk Car Buyers Seaforth</h2>, <h2>Scrap Car Removal Seaforth</h2>,{" "}
        <h2>Top Dollar for Cars Seaforth</h2>,{" "}
        <h2>Unwanted Car Removal Seaforth</h2>, <h2>Old Car Buyers Seaforth</h2>
        , <h2>Free Car Valuation Seaforth</h2>,{" "}
        <h2>Quick Cash for Cars Seaforth</h2>,{" "}
        <h2>Scrap Car Buyers Seaforth Sydney</h2>,{" "}
        <h2>Cash for Damaged Cars Seaforth</h2>,{" "}
        <h2>Sell Your Car Fast Seaforth</h2>,{" "}
        <h2>Cash for Unregistered Cars Seaforth</h2>,{" "}
        <h2>Wrecked Car Removal Seaforth</h2>, <h2>Best Car Buyers Seaforth</h2>
        , <h2>Same Day Car Removal Seaforth</h2>,{" "}
        <h2>Get Cash for Your Car Seaforth</h2>,{" "}
        <h2>Top Car Removal Services Seaforth Sydney</h2>,{" "}
      </>
    ),
  },
  // location 2
