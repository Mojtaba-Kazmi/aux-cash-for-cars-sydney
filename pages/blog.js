...
export async function getServerSideProps() {
  return {
    props: {
      title: "Blogs - Aux Cash For Cars Sydney",
      description:
      ...
      url: `https://auxcashforcarsydney.com/blog`,
      keyword:
...
function blog({ title, description, image, url, keyword, width, height }) {
    ...
    <Head>
      ...
      <Container>
        <Box width={"100%"} overflow={"Hidden"}>
          ...
          <Grid
            container
            sx={{ rowGap: "40px", mt: "10px", justifyContent: "space-between" }}
          >
            {/* post1 in page */}
