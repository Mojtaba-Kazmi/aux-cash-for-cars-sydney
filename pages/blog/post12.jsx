...
export async function getServerSideProps() {
  return {
    props: {
      ...
      image: "https://auxcashforcarsydney.com/assets/postImage/recoverd-cars.jpg",
      url: "https://auxcashforcarsydney.com/blog/post12",
      keyword:
        "cash for cars sydney, Car Removal Sydney,sell my old car, getting scamed, recive payment safely",
      width: 1200,
      height: 630,
    },
  };
