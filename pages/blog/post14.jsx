...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash for Cars Near Me",
      description:
        "Do you have an old or unwanted car taking up space in your garage or driveway? In this article, we'll explore some tips for finding the best car removal service in your area.",
      image: "https://auxcashforcarsydney.com/assets/postImage/14.jpg",
      url: `https://auxcashforcarsydney.com/blog/post14`,
      keyword:
