...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "introducing the best car removal in Sydney that picks up your car for free and pays the highest money for your old, unwanted, damaged, and ... car.",
      image: "https://auxcashforcarsydney.com/assets/postImage/15.jpg",
      url: `https://auxcashforcarsydney.com/blog/post15`,
      keyword:
