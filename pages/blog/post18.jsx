...
export async function getServerSideProps() {
  return {
    props: {
      title: "sell car for cash",
      description:
        "this topic is A guide for: sell car for cash and at the end, we will introduce The best cash for cars company for you.",
      image: "https://auxcashforcarsydney.com/assets/postImage/18.jpg",
      url: `https://auxcashforcarsydney.com/blog/post18`,
      keyword:
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{post[18].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
