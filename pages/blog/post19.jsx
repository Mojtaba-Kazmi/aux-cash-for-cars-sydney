...
export async function getServerSideProps() {
  return {
    props: {
      title: "car scrap pick up",
      description:
        "this topic is A guide for: car scrap pick up and at the end, we will introduce The best car scrap pick up company for you.",
      image: "https://auxcashforcarsydney.com/assets/postImage/19.jpg",
      url: `https://auxcashforcarsydney.com/blog/post19`,
      keyword:
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{post[19].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
