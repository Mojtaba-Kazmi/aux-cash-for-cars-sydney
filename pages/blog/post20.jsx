...
export async function getServerSideProps() {
  return {
    props: {
      title: "Scrap Cars for Cash",
      description:
        "This topic is A guide for Scrap Cars for Cash and at the end, we will introduce The best Scrap Cars buyer company for you.",
      image: "https://auxcashforcarsydney.com/assets/postImage/20.jpg",
      url: `https://auxcashforcarsydney.com/blog/post20`,
      keyword:
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{post[20].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
