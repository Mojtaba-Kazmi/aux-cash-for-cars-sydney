...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Scrap Car Removal and at the end, we will introduce The best Scrap Car Removal company for you.",
      image: "https://auxcashforcarsydney.com/assets/postImage/21.jpg",
      url: `https://auxcashforcarsydney.com/blog/post21`,
      keyword:
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{post[21].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
