...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for cash for scrap cars and at the end, we will introduce The best cash for scrap cars company for you.",
      image: "https://auxcashforcarsydney.com/assets/postImage/22.jpg",
      url: `https://auxcashforcarsydney.com/blog/post22`,
      keyword:
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{post[22].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
