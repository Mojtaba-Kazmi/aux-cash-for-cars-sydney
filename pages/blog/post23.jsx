...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Cash for Unwanted Cars and at the end, we will introduce The best Cash for Unwanted Cars company for you.",
      image: "https://auxcashforcarsydney.com/assets/postImage/23.jpg",
      url: `https://auxcashforcarsydney.com/blog/post23`,
      keyword:
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{post[23].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
