...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal South Western NSW and at the end, we will introduce The best car removal company in South Western NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/10.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location10`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[10].title}
                  />
                  <CardContent>
                    <h1>{location[10].title}</h1>
