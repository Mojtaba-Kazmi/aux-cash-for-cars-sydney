...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal St George NSW and at the end, we will introduce The best car removal company in South Western NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/11.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location11`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    title={location[11].title}
                    alt={location[11].title}
                  />
                  <CardContent>
                    <h1>{location[11].title}</h1>
