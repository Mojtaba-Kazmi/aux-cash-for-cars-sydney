...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Sutherland Shire NSW and at the end, we will introduce The best car removal company in Sutherland Shire NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/12.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location12`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[12].title}
                  />
                  <CardContent>
                    <h1>{location[12].title}</h1>
