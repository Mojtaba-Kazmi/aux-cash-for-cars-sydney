...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Macarthur Region NSW and at the end, we will introduce The best car removal company in Macarthur Region NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/13.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location13`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[13].title}
                  />
                  <CardContent>
                    <h1>{location[13].title}</h1>
