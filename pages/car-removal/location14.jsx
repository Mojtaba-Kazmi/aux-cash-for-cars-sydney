...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Outer Western Suburbs NSW and at the end, we will introduce The best car removal company in Outer Western Suburbs NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/14.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location14`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    title={location[14].title}
                    alt={location[14].title}
                  />
                  <CardContent>
                    <h1>{location[14].title}</h1>
