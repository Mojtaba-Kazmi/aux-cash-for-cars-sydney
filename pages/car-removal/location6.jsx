...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Northern Beaches NSW and at the end, we will introduce The best car removal company in Northern Beaches NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/6.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location6`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[6].title}
                  />
                  <CardContent>
                    <h1>{location[6].title}</h1>
