...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Gladesville Ryde Eastwood NSW and at the end, we will introduce The best car removal company in Gladesville Ryde Eastwood NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/7.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location7`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[7].title}
                  />
                  <CardContent>
                    <h1>{location[7].title}</h1>
