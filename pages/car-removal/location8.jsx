...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Western Sydney Suburbs NSW and at the end, we will introduce The best car removal company in Western Sydney Suburbs NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/8.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location8`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[8].title}
                  />
                  <CardContent>
                    <h1>{location[8].title}</h1>
