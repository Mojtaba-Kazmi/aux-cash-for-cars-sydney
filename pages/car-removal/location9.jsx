...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Car Removal Hills District NSW and at the end, we will introduce The best car removal company in Hills District NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/carRemovalImages/9.jpg",
      url: `https://auxcashforcarsydney.com/car-removal/location9`,
      keyword:
              ...
              <BigCardStyle>
                <Card>
                  <CardMedia
                    ...
                    alt={location[9].title}
                  />
                  <CardContent>
                    <h1>{location[9].title}</h1>
