...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover the easiest way to turn your unwanted car into instant cash in Sydney with Aux Cash for Cars! Get a quick and hassle-free cash quote for your car by simply filling out our online form or giving us a call. We offer top dollar for all makes and models, providing a seamless and efficient car selling experience. Say goodbye to your old vehicle and hello to cash today with Aux Cash for Cars Sydney!",
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={question[3].image}
                    title={question[3].title}
                    alt={question[3].title}
                  />
                  <CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{question[3].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
