...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover a hassle-free way to sell your car for cash in Sydney with Aux Cash for Cars. No need to worry about extensive paperwork – our streamlined process ensures a smooth transaction. Get top dollar for your vehicle without the hassle of complicated documentation. Sell your car effortlessly with Aux Cash for Cars Sydney!",
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={question[4].image}
                    title={question[4].title}
                    alt={question[4].title}
                  />
                  <CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{question[4].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
