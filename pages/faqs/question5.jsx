...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover hassle-free car selling with Aux Cash for Cars Sydney! We buy cars of all makes and models, regardless of their condition. No restrictions apply – whether your car is old, damaged, or no longer running, we offer top cash deals. Say goodbye to unwanted vehicles and hello to instant cash! Contact us today for a seamless selling experience in Sydney.",
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={question[5].image}
                    title={question[5].title}
                    alt={question[5].title}
                  />
                  <CardContent>
                    <h1>{question[5].title}</h1>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{question[5].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
