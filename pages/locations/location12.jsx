...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Sutherland Shire NSW",
      description:
        "This topic is A guide for Cash For Cars Sutherland Shire NSW and at the end, we will introduce The best Cash for Cars company in Sutherland Shire NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/12.jpg",
      url: `https://auxcashforcarsydney.com/locations/location12`,
      keyword:
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={location[12].image}
                    title={location[12].alt}
                    alt={location[12].alt}
                  />
                  <CardContent>
                    {location[12].title}
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{location[12].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
