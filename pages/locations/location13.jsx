...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Macarthur Region NSW",
      description:
        "This topic is A guide for Cash For Cars Macarthur Region NSW and at the end, we will introduce The best Cash for Cars company in Macarthur Region NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/13.jpg",
      url: `https://auxcashforcarsydney.com/locations/location13`,
      keyword:
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={location[13].image}
                    title={location[13].alt}
                    alt={location[13].alt}
                  />
                  <CardContent>
                    {location[13].title}
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{location[13].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
