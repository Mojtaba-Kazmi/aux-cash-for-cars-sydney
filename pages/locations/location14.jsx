...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Outer Western Suburbs NSW",
      description:
        "This topic is A guide for Cash For Cars Outer Western Suburbs NSW and at the end, we will introduce The best Cash for Cars company in Outer Western Suburbs NSW for you.",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/14.jpg",
      url: `https://auxcashforcarsydney.com/locations/location14`,
      keyword:
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={location[14].image}
                    title={location[14].alt}
                    alt={location[14].alt}
                  />
                  <CardContent>
                    {location[14].title}
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{location[14].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
