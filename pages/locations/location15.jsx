...
export async function getServerSideProps() {
  return {
    props: {
      title: "Aux Cash for Cars Sydney service all the Sydney wide suburbs",
      description:
        "Aux Cash for Cars Sydney service all the Sydney wide suburbs",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/15.jpg",
      url: `https://auxcashforcarsydney.com/locations/location15`,
      keyword:
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={location[15].image}
                    title={location[15].alt}
                    alt={location[15].alt}
                  />
                  <CardContent>
                    {location[15].title}
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{location[15].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
