...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Cash for Cars Eastern NSW and at the end, we will introduce The best Cash for Cars company in Cash for Cars Eastern NSW  for you.",
