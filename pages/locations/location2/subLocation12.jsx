...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover the Best Cash for Cars Service in Waverley, Sydney - Aux Cash for Cars Sydney! We offer top dollar for your unwanted vehicles, providing a seamless car removal experience. Sell your old, damaged, or used cars for instant cash, with our reliable and efficient process. Turn your car into money effortlessly with our trusted services. Contact us today to get the best value for your car in Waverley, Sydney!",
      image: "/assets/locationsImages/sublocation1Images/20.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation12`,
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={subLocation[12].image}
                    title={subLocation[12].title}
                    alt={subLocation[12].title}
                  />
                  <CardContent>
                    <h1>{subLocation[12].title}</h1>
                    {subLocation[12].description}
                  </CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{subLocation[12].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
