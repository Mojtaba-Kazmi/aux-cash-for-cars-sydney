...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your car in Vaucluse, Sydney with Aux Cash for Cars! We offer the best cash for cars service in the area, providing quick and hassle-free transactions. Whether you have an old, damaged, or unwanted vehicle, we'll buy it for a competitive price. Experience our reliable and efficient car selling service today!",
      image: "/assets/locationsImages/sublocation1Images/22.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation14`,
