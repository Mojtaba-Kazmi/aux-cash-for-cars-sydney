...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your car in Randwick, Sydney with Aux Cash for Cars! We offer instant cash for cars of all makes and models, regardless of their condition. Our hassle-free process makes selling your car easy and quick. Whether your vehicle is old, damaged, or unwanted, we'll buy it! Say goodbye to the stress of selling your car privately and get a fair deal today. Contact Aux Cash for Cars Sydney and turn your old car into cash!",
      image: "/assets/locationsImages/sublocation1Images/23.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation15`,
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={subLocation[15].image}
                    title={subLocation[15].title}
                    alt={subLocation[15].title}
                  />
                  <CardContent>
                    <h1>{subLocation[15].title}</h1>
                    {subLocation[15].description}
                  </CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{subLocation[15].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
