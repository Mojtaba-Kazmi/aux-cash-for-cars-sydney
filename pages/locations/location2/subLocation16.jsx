...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Looking to sell your car in Kingsford, Sydney? Look no further! Aux Cash for Cars Sydney offers top dollar for your vehicle, regardless of its make, model, or condition. We provide instant cash for cars, hassle-free pickups, and excellent customer service. Whether you have an old car, damaged vehicle, or simply want to free up space, we are your trusted local car buyers. Get the best deal for your car today with Aux Cash for Cars Kingsford, Sydney!",
      image: "/assets/locationsImages/sublocation1Images/24.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation16`,
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={subLocation[16].image}
                    title={subLocation[16].title}
                    alt={subLocation[16].title}
                  />
                  <CardContent>
                    <h1>{subLocation[16].title}</h1>
                    {subLocation[16].description}
                  </CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{subLocation[16].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
