            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={subLocation[17].image}
                    title={subLocation[17].title}
                    alt={subLocation[17].title}
                  />
                  <CardContent>
                    <h1>{subLocation[17].title}</h1>
                    {subLocation[17].description}
                  </CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{subLocation[17].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
