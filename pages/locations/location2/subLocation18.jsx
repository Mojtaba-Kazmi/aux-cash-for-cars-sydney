...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Coogee, Sydney with Aux Cash for Cars Sydney! We offer instant cash payments for all types of vehicles, whether old, damaged, or unwanted. Our hassle-free process ensures a quick and easy car selling experience. Contact us now to turn your old car into cash!",
      image: "/assets/locationsImages/sublocation1Images/26.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation18`,
