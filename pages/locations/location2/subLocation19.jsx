...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Looking to sell your car for top dollar in Pagewood, Sydney? Aux Cash for Cars Sydney is your trusted solution! We offer instant cash for all makes and models, regardless of their condition. Our friendly team ensures a hassle-free process and free car removal service. Get the best deal for your vehicle today with Aux Cash for Cars Sydney.",
      image: "/assets/locationsImages/sublocation1Images/27.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation19`,
