...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Matraville, Sydney with Aux Cash for Cars! We offer quick and hassle-free car removal services, paying instant cash for any make and model, regardless of its condition. Earn cash on the spot and enjoy a seamless car selling experience with our trusted team. Contact us now and turn your unwanted vehicle into cash!",
      image: "/assets/locationsImages/sublocation1Images/28.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation20`,
