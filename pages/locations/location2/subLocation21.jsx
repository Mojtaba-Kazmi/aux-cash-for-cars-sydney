...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Randwick, Sydney with Aux Cash for Cars. We offer swift and hassle-free car removal services, turning your old, unwanted vehicles into instant money. Contact us today for a fair appraisal and reliable car removal service in Randwick and across Sydney.",
      image: "/assets/locationsImages/sublocation1Images/29.jpg",
      url: `https://auxcashforcarsydney.com/locations/location2/subLocation21`,
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={subLocation[21].image}
                    title={subLocation[21].title}
                    alt={subLocation[21].title}
                  />
                  <CardContent>
                    <h1>{subLocation[21].title}</h1>
                    {subLocation[21].description}
                  </CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{subLocation[21].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
