...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Looking to sell your car for cash in Cremorne, Sydney? Look no further! Aux Cash for Cars Sydney offers top-dollar payments, free vehicle removal, and eco-friendly disposal. We accept all makes and models. Your trusted choice for hassle-free car sales in Cremorne.",
      image: "/assets/locationsImages/sublocation1Images/41.jpg",
      url: `https://auxcashforcarsydney.com/locations/location3/subLocation12`,
