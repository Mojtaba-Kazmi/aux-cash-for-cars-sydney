...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Cammeray, Sydney! We offer hassle-free car removal and instant cash payment for all types of vehicles, regardless of condition. Contact us today to turn your old, unwanted car into quick cash",
