...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Crows Nest, Sydney with Aux Cash for Cars. We offer competitive offers, hassle-free transactions, and free car removal. Sell any make or model quickly and efficiently. Experience the best cash-for-cars service in Crows Nest today",
      image: "/assets/locationsImages/sublocation1Images/35.jpg",
      url: `https://auxcashforcarsydney.com/locations/location3/subLocation6`,
