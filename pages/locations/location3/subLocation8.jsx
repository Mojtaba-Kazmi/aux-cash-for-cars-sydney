...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Turn your unwanted car into instant cash in Chatswood, Sydney! Aux Cash for Cars Sydney offers top-dollar payouts and hassle-free car removal services. Get the best value for your vehicle today",
      image: "/assets/locationsImages/sublocation1Images/37.jpg",
      url: `https://auxcashforcarsydney.com/locations/location3/subLocation8`,
