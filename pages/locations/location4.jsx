...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Lower North Shore NSW",
      description:
        "Looking to sell your car for cash in Lower North Shore, NSW? Aux Cash for Cars Sydney is your trusted partner for quick and hassle-free cash for cars services. Get top dollar for your vehicle today. Contact us now!",
              ...
              <Grid item md={7.9} sm={12} xs={12}>
                <BigCardStyle>
                  <Card>
                    <CardMedia
                      sx={{ height: "300px" }}
                      image={location[4].image}
                      title={location[4].alt}
                      alt={location[4].alt}
                    />
                    <CardContent>
                      {location[4].title}
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Card>
                      <CardContent>
                        ...
                        <TagsStyle>{location[4].tags}</TagsStyle>
                      </CardContent>
                    </Card>
                  </Grid>
                </Grid>
              ...
              >
                <Postanimation>
                  <Card height={"100%"}>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location4/subLocation" + ps1}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location4/subLocation" + ps2}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location4/subLocation" + ps3}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location4/subLocation" + ps4}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location4/subLocation" + ps5}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location4/subLocation" + ps6}>
                          <TitleContainer>
