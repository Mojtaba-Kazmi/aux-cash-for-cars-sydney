...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Aux Cash for Cars Sydney in Five Dock offers top cash for cars in Sydney. We buy all types of vehicles, providing a hassle-free and efficient service. Get instant cash for your unwanted cars today!",
      image: "/assets/locationsImages/sublocation1Images/51.jpg",
      url: `https://auxcashforcarsydney.com/locations/location4/subLocation10`,
