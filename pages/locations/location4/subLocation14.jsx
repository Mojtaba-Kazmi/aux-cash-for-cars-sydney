...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your unwanted vehicles in Camperdown, Sydney with Aux Cash for Cars Sydney! We offer fast and hassle-free cash for cars service, turning your old, damaged, or scrap cars into instant cash. Contact us today for a quick and convenient car selling experience.",
      image: "/assets/locationsImages/sublocation1Images/55.jpg",
      url: `https://auxcashforcarsydney.com/locations/location4/subLocation14`,
