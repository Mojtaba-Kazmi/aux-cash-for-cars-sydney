...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Looking to sell your car for cash in Balmain, Sydney? Aux Cash for Cars Sydney offers top-dollar payouts for your unwanted vehicles. Get fast and hassle-free cash for cars in Balmain today!",
      image: "/assets/locationsImages/sublocation1Images/46.jpg",
      url: `https://auxcashforcarsydney.com/locations/location4/subLocation5`,
