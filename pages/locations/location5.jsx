              ...
              <Grid item md={7.9} sm={12} xs={12}>
                <BigCardStyle>
                  <Card>
                    <CardMedia
                      sx={{ height: "300px" }}
                      image={location[5].image}
                      title={location[5].alt}
                      alt={location[5].alt}
                    />
                    <CardContent>
                      {location[5].title}
                      {location[5].description}
                    </CardContent>
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Card>
                      <CardContent>
                        ...
                        <TagsStyle>{location[5].tags}</TagsStyle>
                      </CardContent>
                    </Card>
                  </Grid>
                </Grid>
              ...
              >
                <Postanimation>
                  <Card height={"100%"}>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location5/subLocation" + ps1}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location5/subLocation" + ps2}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location5/subLocation" + ps3}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location5/subLocation" + ps4}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location5/subLocation" + ps5}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location5/subLocation" + ps6}>
                          <TitleContainer>
