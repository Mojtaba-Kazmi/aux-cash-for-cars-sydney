...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your unwanted cars in Lindfield, Sydney with Aux Cash for Cars! We offer quick and hassle-free cash for cars services, turning your old vehicles into instant cash. Contact us today for a free quote and enjoy a seamless car selling experience.",
      image: "/assets/locationsImages/sublocation1Images/56.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation1`,
