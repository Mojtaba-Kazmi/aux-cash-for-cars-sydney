...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover hassle-free cash for cars services in Berowra Waters, Sydney with Aux Cash for Cars Sydney. We offer top dollar for your unwanted vehicles, providing a convenient and efficient solution to sell your car. Whether old, damaged, or no longer in use, turn your car into instant cash. Contact us today for a quick and transparent process, ensuring a smooth transaction for your unwanted vehicle in Berowra Waters, Sydney.",
      image: "/assets/locationsImages/sublocation1Images/67.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation11`,
