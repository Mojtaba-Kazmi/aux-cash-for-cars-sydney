...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Terrey Hills, Sydney with Aux Cash for Cars. We offer instant quotes, free car removal, and a hassle-free process. Sell your old, damaged, or unwanted car today and receive top dollar. Fast, reliable, and efficient service to turn your car into cash. Contact us now for a seamless car selling experience in Terrey Hills, Sydney!",
      image: "/assets/locationsImages/sublocation1Images/68.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation12`,
