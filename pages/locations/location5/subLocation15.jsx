...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Forestville, Sydney with Aux Cash for Cars! We offer hassle-free car removal services, accepting vehicles in any condition. Sell your old, damaged, or unwanted cars and receive instant cash on the spot. Our experienced team ensures a seamless process from appraisal to pickup. Contact Aux Cash for Cars Sydney today and turn your unwanted car into quick cash in Forestville!",
      image: "/assets/locationsImages/sublocation1Images/71.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation15`,
