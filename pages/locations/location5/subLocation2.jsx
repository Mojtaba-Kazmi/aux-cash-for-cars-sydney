...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Looking to sell your car in Killara, Sydney? Aux Cash for Cars Sydney offers top cash for cars in Killara and the surrounding areas. We buy all makes and models, providing a hassle-free and convenient car selling experience. Get instant cash for your vehicle today!",
      image: "/assets/locationsImages/sublocation1Images/57.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation2`,
