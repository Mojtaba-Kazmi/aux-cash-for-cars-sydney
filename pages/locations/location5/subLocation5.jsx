...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for your car in Turramurra, Sydney with Aux Cash for Cars. We offer quick and hassle-free car removal services, turning your unwanted vehicles into instant cash. Contact us today for a seamless and efficient way to sell your car in Turramurra and surrounding areas.",
      image: "/assets/locationsImages/sublocation1Images/61.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation5`,
