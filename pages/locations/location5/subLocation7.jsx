...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for your cars in Wahroonga, Sydney with Aux Cash for Cars! We offer swift and hassle-free car removal services, providing instant cash for vehicles in any condition. Whether your car is old, damaged, or simply unwanted, we guarantee the best prices and a seamless transaction process. Contact Aux Cash for Cars Sydney today and turn your unused vehicle into instant cash in Wahroonga!",
      image: "/assets/locationsImages/sublocation1Images/63.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation7`,
