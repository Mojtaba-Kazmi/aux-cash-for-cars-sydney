...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Turn your old or unwanted car into instant cash in Mount Colah, Sydney with Aux Cash for Cars. We offer top-dollar payouts for all types of vehicles, providing a seamless and efficient solution to sell your car. Whether it's running or not, damaged, or simply no longer needed, we ensure a fast and transparent process. Contact Aux Cash for Cars today for the best cash for cars service in Mount Colah, Sydney, and experience a hassle-free way to sell your car.",
      image: "/assets/locationsImages/sublocation1Images/65.jpg",
      url: `https://auxcashforcarsydney.com/locations/location5/subLocation9`,
