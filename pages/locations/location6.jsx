...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your unwanted vehicles in Northern Beaches, NSW with Aux Cash for Cars Sydney! We offer instant cash for cars, trucks, and vans, regardless of their condition. Our hassle-free process ensures a quick and convenient way to sell your car for cash. Contact us today for a seamless car selling experience in Northern Beaches, NSW!",
              ...
              <Grid item md={7.9} sm={12} xs={12}>
                <BigCardStyle>
                  <Card>
                    <CardMedia
                      sx={{ height: "300px" }}
                      image={location[6].image}
                      title={location[6].alt}
                      alt={location[6].alt}
                    />
                    <CardContent>
                      {location[6].title}
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Card>
                      <CardContent>
                        ...
                        <TagsStyle>{location[6].tags}</TagsStyle>
                      </CardContent>
                    </Card>
                  </Grid>
                </Grid>
              ...
              >
                <Postanimation>
                  <Card height={"100%"}>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location6/subLocation" + ps1}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location6/subLocation" + ps2}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location6/subLocation" + ps3}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location6/subLocation" + ps4}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location6/subLocation" + ps5}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location6/subLocation" + ps6}>
                          <TitleContainer>
