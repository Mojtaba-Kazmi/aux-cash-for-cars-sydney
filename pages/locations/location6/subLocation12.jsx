...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover top-dollar deals with Aux Cash for Cars in Newport, Sydney! We offer hassle-free cash for cars services, ensuring a quick and convenient way to sell your vehicle. Get instant quotes, free towing, and on-the-spot payments. Turn your unwanted cars into cash today with Aux Cash for Cars in Newport, Sydney!",
      image: "/assets/locationsImages/sublocation1Images/83.jpg",
      url: `https://auxcashforcarsydney.com/locations/location6/subLocation12`,
