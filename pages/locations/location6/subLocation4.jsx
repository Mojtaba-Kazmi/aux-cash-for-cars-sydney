...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover the easiest way to sell your car in Harbord, Sydney with Aux Cash for Cars. We offer top cash for cars, hassle-free transactions, and quick pickups. Turn your unwanted vehicle into instant cash – contact us today for a seamless and efficient car selling experience in Harbord.",
      image: "/assets/locationsImages/sublocation1Images/75.jpg",
      url: `https://auxcashforcarsydney.com/locations/location6/subLocation4`,
