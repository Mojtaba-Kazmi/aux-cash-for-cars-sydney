...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Collaroy, Sydney with Aux Cash for Cars Sydney! We offer hassle-free and swift car removal services, accepting vehicles in any condition. Whether your car is old, damaged, or no longer running, we provide on-the-spot cash payments. Contact us today for a seamless and efficient process to sell your car and earn instant cash in Collaroy, Sydney.",
