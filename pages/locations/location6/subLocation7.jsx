...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Brookvale, Sydney with Aux Cash for Cars Sydney! We offer hassle-free car removal services, providing instant cash for your unwanted vehicles. Whether your car is old, damaged, or simply unwanted, we guarantee a fair and competitive cash offer. Contact us today for a quick and efficient car selling experience in Brookvale, Sydney.",
      image: "/assets/locationsImages/sublocation1Images/78.jpg",
      url: `https://auxcashforcarsydney.com/locations/location6/subLocation7`,
