...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for your unwanted cars in Narrabeen, Sydney with Aux Cash for Cars Sydney! We offer hassle-free car removal services, ensuring a quick and efficient process. Turn your old, damaged, or unwanted vehicles into instant cash. Contact us today for a seamless cash for cars experience in Narrabeen and surrounding areas!",
      image: "/assets/locationsImages/sublocation1Images/79.jpg",
      url: `https://auxcashforcarsydney.com/locations/location6/subLocation8`,
