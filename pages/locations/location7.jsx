...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Gladesville–Ryde–Eastwood NSW",
      description:
        "Get top cash for cars in Gladesville, Ryde, and Eastwood, NSW with Aux Cash for Cars Sydney. We offer hassle-free car removal and instant cash payment for your unwanted vehicles. Contact us today for a quick quote and enjoy a seamless car selling experience!",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/7.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7`,
      keyword:
              ...
              <Grid item md={7.9} sm={12} xs={12}>
                <BigCardStyle>
                  <Card>
                    <CardMedia
                      sx={{ height: "300px" }}
                      image={location[7].image}
                      title={location[7].alt}
                      alt={location[7].alt}
                    />
                    <CardContent>
                      {location[7].title}
                      {location[7].description}
                    </CardContent>
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Card>
                      <CardContent>
                        ...
                        <TagsStyle>{location[7].tags}</TagsStyle>
                      </CardContent>
                    </Card>
                  </Grid>
                </Grid>
        ...
        >
          <Box>
            <Container>
              ...
              >
                Gladesville–Ryde–Eastwood NSW Suburbs
              </Typography>
            </Container>
          </Box>
              ...
              >
                <Postanimation>
                  <Card height={"100%"}>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location7/subLocation" + ps1}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location7/subLocation" + ps2}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location7/subLocation" + ps3}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location7/subLocation" + ps4}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location7/subLocation" + ps5}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location7/subLocation" + ps6}>
                          <TitleContainer>
