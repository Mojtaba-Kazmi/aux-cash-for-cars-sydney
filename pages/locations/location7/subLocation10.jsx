...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for your unwanted cars in Pennant Hills, Sydney with Aux Cash for Cars. We offer hassle-free car removal services, ensuring quick payouts and a seamless process. Contact us today for a fair quote and swift car removal service!",
      image: "/assets/locationsImages/sublocation1Images/93.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7/subLocation10`,
