...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover Aux Cash for Cars Sydney's hassle-free cash for cars service in Epping, Sydney. We offer top dollar for your unwanted vehicles, providing efficient and reliable car removals throughout the Epping area. Contact us today for instant cash and swift removal of your old, damaged, or unwanted cars.",
      image: "/assets/locationsImages/sublocation1Images/94.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7/subLocation11`,
