...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover top-notch cash for cars services in Ryde, Sydney with Aux Cash for Cars. Get instant quotes, hassle-free pickups, and competitive prices for your unwanted vehicles. Sell your car fast and conveniently with Aux Cash for Cars Sydney today!",
      image: "/assets/locationsImages/sublocation1Images/86.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7/subLocation3`,
