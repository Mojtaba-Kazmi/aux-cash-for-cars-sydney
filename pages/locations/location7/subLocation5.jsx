...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Looking to sell your car in Meadowbank, Sydney? Aux Cash for Cars offers top cash deals for your vehicle, with hassle-free services and quick transactions. Get an instant quote and sell your car for cash today!",
      image: "/assets/locationsImages/sublocation1Images/88.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7/subLocation5`,
