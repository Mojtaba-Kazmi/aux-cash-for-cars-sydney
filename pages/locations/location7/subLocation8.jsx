...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get instant cash for cars in Telopea, Carlingford, Sydney with Aux Cash for Cars. We offer hassle-free car removal services, providing top dollar for your unwanted vehicles. Contact us today for a quick and easy transaction.",
      image: "/assets/locationsImages/sublocation1Images/91.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7/subLocation8`,
