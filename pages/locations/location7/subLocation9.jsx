...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Beecroft, Sydney with Aux Cash for Cars. We offer hassle-free car removal and instant cash payments for all types of vehicles, regardless of their condition. Contact us today for a quick and efficient car selling experience.",
      image: "/assets/locationsImages/sublocation1Images/92.jpg",
      url: `https://auxcashforcarsydney.com/locations/location7/subLocation9`,
