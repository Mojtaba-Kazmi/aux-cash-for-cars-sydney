...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Western Sydney Suburbs NSW",
      description:
        "Aux Cash for Cars offers top cash for cars in Western Sydney Suburbs, NSW. Get instant cash for your unwanted vehicles with hassle-free pickup and same-day payment. Contact us today!",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/8.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8`,
      keyword:
              ...
              <Grid item md={7.9} sm={12} xs={12}>
                <BigCardStyle>
                  <Card>
                    <CardMedia
                      sx={{ height: "300px" }}
                      image={location[8].image}
                      title={location[8].alt}
                      alt={location[8].alt}
                    />
                    <CardContent>
                      {location[8].title}
                      {location[8].description}
                    </CardContent>
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Card>
                      <CardContent>
                        ...
                        <TagsStyle>{location[8].tags}</TagsStyle>
                      </CardContent>
                    </Card>
                  </Grid>
                </Grid>
        ...
        >
          <Box>
            <Container>
              ...
              >
                Cash For Cars Western Sydney Suburbs NSW
              </Typography>
            </Container>
          </Box>
              ...
              >
                <Postanimation>
                  <Card height={"100%"}>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location8/subLocation" + ps1}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location8/subLocation" + ps2}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location8/subLocation" + ps3}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location8/subLocation" + ps4}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location8/subLocation" + ps5}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location8/subLocation" + ps6}>
                          <TitleContainer>
