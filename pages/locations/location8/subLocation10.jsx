...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Concord, Sydney with Aux Cash for Cars Sydney. We offer quick and hassle-free car removal services, turning your unwanted vehicles into instant cash. Contact us today for a free quote!",
      image: "/assets/locationsImages/sublocation1Images/107.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation10`,
