...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your unwanted vehicles in Homebush, Sydney with Aux Cash for Cars! We offer hassle-free cash for cars service, ensuring quick pickups and fair quotes. Say goodbye to your old car and hello to instant cash today!",
      image: "/assets/locationsImages/sublocation1Images/109.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation12`,
