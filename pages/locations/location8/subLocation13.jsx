...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Lidcombe, Sydney with Aux Cash for Cars! We offer hassle-free car removal services, paying instant cash for all types of vehicles in any condition. Contact us now for a quick and easy transaction!",
      image: "/assets/locationsImages/sublocation1Images/110.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation13`,
