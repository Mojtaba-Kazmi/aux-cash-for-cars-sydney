...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Granville, Sydney with Aux Cash for Cars Sydney! We offer hassle-free car removal services and instant cash payments for your old, damaged, or unwanted vehicles. Contact us today for a quick and convenient solution to sell your car for cash in Granville.",
      image: "/assets/locationsImages/sublocation1Images/111.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation14`,
