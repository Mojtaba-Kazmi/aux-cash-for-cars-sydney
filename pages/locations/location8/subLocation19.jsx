...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Aux Cash for Cars Sydney offers top cash for cars in Seven Hills, Sydney. We provide fast and hassle-free car removal services, accepting all makes and models in any condition. Get an instant quote and same-day pickup with guaranteed best prices. Turn your unwanted vehicle into cash today!",
      image: "/assets/locationsImages/sublocation1Images/116.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation19`,
            ...
            <Grid item md={7.9} sm={12} xs={12}>
              <BigCardStyle>
                <Card>
                  <CardMedia
                    sx={{ height: "300px" }}
                    image={subLocation[19].image}
                    title={subLocation[19].title}
                    alt={subLocation[19].title}
                  />
                  <CardContent>
                    <h1>{subLocation[19].title}</h1>
                    {subLocation[19].description}
                  </CardContent>
                ...
                <Grid item md={12} sm={12} xs={12}>
                  <Card>
                    <CardContent>
                      ...
                      <TagsStyle>{subLocation[19].tags}</TagsStyle>
                    </CardContent>
                  </Card>
                </Grid>
              </Grid>
