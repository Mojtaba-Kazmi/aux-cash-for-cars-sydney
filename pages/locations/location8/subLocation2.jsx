...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top cash for cars in Silverwater, Sydney with Aux Cash for Cars! We offer hassle-free vehicle removal services and instant cash payouts for your unwanted cars, trucks, and vans. Contact us today for a quick and convenient solution to sell your car for cash!",
      image: "/assets/locationsImages/sublocation1Images/99.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation2`,
