...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover the hassle-free solution for selling your unwanted cars in Summer Hill, Sydney with Aux Cash for Cars. Get top cash offers for your vehicles, regardless of their condition. Fast, reliable service with free car removal included. Contact us today!",
      image: "/assets/locationsImages/sublocation1Images/100.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation3`,
