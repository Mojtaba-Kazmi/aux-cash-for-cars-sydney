...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Discover hassle-free cash for cars in Ashfield, Sydney with Aux Cash for Cars. We offer top dollar for your unwanted vehicles, providing swift and convenient removal services. Turn your old car into instant cash today!",
      image: "/assets/locationsImages/sublocation1Images/101.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation4`,
