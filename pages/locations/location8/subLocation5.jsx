...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Aux Cash for Cars Sydney offers top cash deals for your unwanted vehicles in Croydon, Sydney. Get instant quotes and same-day car removal services. Turn your old, damaged, or scrap cars into cash hassle-free. Contact us now!",
      image: "/assets/locationsImages/sublocation1Images/102.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation5`,
