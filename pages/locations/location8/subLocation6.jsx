...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Aux Cash for Cars Sydney offers top cash for cars in Croydon Park, Sydney. Get instant cash for your old, unwanted vehicles. Contact us today for a hassle-free car selling experience!",
      image: "/assets/locationsImages/sublocation1Images/103.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation6`,
