...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Aux Cash for Cars Sydney offers top dollar cash for cars in Burwood, Sydney. We provide hassle-free car removal services, turning your old, unwanted vehicles into instant cash. Contact us today for a quick and convenient way to sell your car!",
      image: "/assets/locationsImages/sublocation1Images/104.jpg",
      url: `https://auxcashforcarsydney.com/locations/location8/subLocation7`,
