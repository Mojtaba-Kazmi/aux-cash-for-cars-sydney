...
export async function getServerSideProps() {
  return {
    props: {
      title: "Cash For Cars Hills District NSW",
      description:
        "Aux Cash for Cars Sydney offers top cash for cars in the Hills District, NSW. We provide a hassle-free service for selling your vehicle, accepting all makes and models in any condition. Enjoy free car removal and instant cash payments with our professional and reliable team. Contact us today for a quick and easy car selling experience.",
      image: "https://auxcashforcarsydney.com/assets/locationsImages/9.jpg",
      url: `https://auxcashforcarsydney.com/locations/location9`,
      keyword:
              ...
              <Grid item md={7.9} sm={12} xs={12}>
                <BigCardStyle>
                  <Card>
                    <CardMedia
                      sx={{ height: "300px" }}
                      image={location[9].image}
                      title={location[9].alt}
                      alt={location[9].alt}
                    />
                    <CardContent>
                      {location[9].title}
                      {location[9].description}
                    </CardContent>
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Card>
                      <CardContent>
                        ...
                        <TagsStyle>{location[9].tags}</TagsStyle>
                      </CardContent>
                    </Card>
                  </Grid>
                </Grid>
        ...
        >
          <Box>
            <Container>
              ...
              >
                Cash For Cars Hills District NSW
              </Typography>
            </Container>
          </Box>
              ...
              >
                <Postanimation>
                  <Card height={"100%"}>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location9/subLocation" + ps1}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location9/subLocation" + ps2}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location9/subLocation" + ps3}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location9/subLocation" + ps4}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location9/subLocation" + ps5}>
                          <TitleContainer>
              ...
              >
                <Postanimation>
                  <Card>
                    ...
                    <CardContent>
                      <MiniCardStyle>
                        <Link href={"/locations/location9/subLocation" + ps6}>
                          <TitleContainer>
