...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "This topic is A guide for Cash For Cars Hills District NSW and at the end, we will introduce The best Cash for Cars company in Cars Hills District NSW for you.",
