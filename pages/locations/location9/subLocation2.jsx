...
export async function getServerSideProps() {
  return {
    props: {
      ...
      description:
        "Get top dollar for your car in North Rocks, Sydney with Aux Cash for Cars! We offer fast, hassle-free car removal services and pay cash on the spot for vehicles of all makes and models. Whether your car is old, damaged, or simply unwanted, we'll provide a fair quote and handle all the paperwork. Contact us today to turn your car into cash effortlessly!",
      image: "/assets/locationsImages/sublocation1Images/119.jpg",
      url: `https://auxcashforcarsydney.com/locations/location9/subLocation2`,
